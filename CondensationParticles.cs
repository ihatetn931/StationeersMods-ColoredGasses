                    ...
                    try
                    {
                        ...
                        if (atmosphericFog.IsEmitting() && !atmosphericFog.IsEmitCooldown)
                        {
                            if (ColoredGasses.toggleColorCondensationParticles.Value)
                            {
                                ...
                                {
                                    emitParams.startColor = new Color32((byte)ColoredGasses.RGBRedWater.Value, (byte)ColoredGasses.RGBGreenWater.Value, (byte)ColoredGasses.RGBBlueWater.Value, 255);
                                    AtmosphericFog.AtmosphericFogParticleSystem.Emit(emitParams, 1);
                                }
                                if (liquidCo2 / 100 > maxValue)
                                {
                                    emitParams.startColor = new Color32((byte)ColoredGasses.RGBRedCarbon.Value, (byte)ColoredGasses.RGBGreenCarbon.Value, (byte)ColoredGasses.RGBBlueCarbon.Value, 255);
                                    AtmosphericFog.AtmosphericFogParticleSystem.Emit(emitParams, 1);
                                }
                                if (liquidNitrogen / 100 > maxValue)
                                {
                                    emitParams.startColor = new Color32((byte)ColoredGasses.RGBRedNitrogen.Value, (byte)ColoredGasses.RGBGreenNitrogen.Value, (byte)ColoredGasses.RGBBlueNitrogen.Value, 255);
                                    AtmosphericFog.AtmosphericFogParticleSystem.Emit(emitParams, 1);
                                }
                                if (liquidNitrousOxide / 100 > maxValue)
                                {
                                    emitParams.startColor = new Color32((byte)ColoredGasses.RGBRedNitrousOxide.Value, (byte)ColoredGasses.RGBGreenNitrousOxide.Value, (byte)ColoredGasses.RGBBlueNitrousOxide.Value, 255);
                                    AtmosphericFog.AtmosphericFogParticleSystem.Emit(emitParams, 1);
                                }
                                if (liquidOxygen / 100 > maxValue)
                                {
                                    emitParams.startColor = new Color32((byte)ColoredGasses.RGBRedOxygen.Value, (byte)ColoredGasses.RGBGreenOxygen.Value, (byte)ColoredGasses.RGBBlueOxygen.Value, 255);
                                    AtmosphericFog.AtmosphericFogParticleSystem.Emit(emitParams, 1);
                                }
                                if (liquidPollutant / 100 > maxValue)
                                {
                                    emitParams.startColor = new Color32((byte)ColoredGasses.RGBRedPollutant.Value, (byte)ColoredGasses.RGBGreenPollutant.Value, (byte)ColoredGasses.RGBBluePollutant.Value, 255);
                                    AtmosphericFog.AtmosphericFogParticleSystem.Emit(emitParams, 1);
                                }
                                if (liquidVolatiles / 100 > maxValue)
                                {
                                    emitParams.startColor = new Color32((byte)ColoredGasses.RGBRedVolatiles.Value, (byte)ColoredGasses.RGBGreenVolatiles.Value, (byte)ColoredGasses.RGBBlueVolatiles.Value, 255);
                                    AtmosphericFog.AtmosphericFogParticleSystem.Emit(emitParams, 1);
                                }
                            }
                            else
